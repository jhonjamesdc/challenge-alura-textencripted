...
function actualizarPantalla(){
    ...
    document.querySelector("#imgMensajeNull").style.display="none";
    document.querySelector("#mensajeNull").style.display="none";
    document.querySelector("#descMensajeNull").style.display="none";
    document.querySelector("#resultado").style.display="inline-block";
    document.querySelector("#copy").style.display="inline-block";
    
    /* Este código generaba los elementos textarea y boton copy cuando se encriptaba por primera vez
    document.querySelector("#mensajes").innerHTML =
    '<textarea maxlength="5000" cols="50" rows="11" id="resultado" class="texto"></textarea>' + 
    '<input type="submit" value="Copiar" class="copy" id="copy">';
